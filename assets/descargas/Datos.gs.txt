...
var RETOS_REGULAR = [
  ...
  ["L2","Reto relámpago «El vídeo que pregunta» (recupera a Tomás)",["P2_tomas"],100,2,4],
  ["B2","Reto principal «El eco que enseña» (tu videotutorial)",["R2_el-eco-que-ensena"],250,2],
...
var AYUDA_RETOS = {
 ...
 "L2": "Quince minutos, en clase. Coge un vídeo —tu videotutorial o uno ya hecho de tu área— y métele dentro dos o tres preguntas con Edpuzzle o Playposit, justo después de cada paso difícil. Pídele las preguntas a una IA y quédate con las que de verdad comprueban que se ha entendido. ¿No te da tiempo? Encuentra un vídeo que ya tenga preguntas dentro y que te sirva para tu aula. Pega el enlace.",
