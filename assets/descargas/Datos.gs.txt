...
var AYUDA_RETOS = {
 ...
 "A6": "Coge algo que tus alumnos temen o les cuesta y conviértelo en un pequeño ensayo jugable, digital o analógico (una mecánica: puntos, rutas, unas cartas, un enigma en cada paso…). Cuéntalo aquí mismo, en la caja del reto, en 4–6 líneas: qué les cuesta, a qué se juega y qué aprenden jugando. Si es digital (o tienes una foto), añade el enlace. Criterio: que el juego sirva a un objetivo, no que sea juego por juego.",
