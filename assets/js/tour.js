...
(function(){
  ...
  var BASE=[
   ...
   {p:'guia.html',sel:'#retos',pose:'tablet',t:'Dos retos por tema',x:'Los dos prácticos. El <b>relámpago</b>, en clase, recupera al tripulante y da su <b>insignia</b>: no cuenta para nota, aunque da 100 xp y 20 ◈. El <b>reto principal</b>, en casa, es la experiencia del portfolio del tema (250 xp y 50 ◈) y <b>pide su enlace</b>. Los <b>xp</b> suben de nivel y nunca se gastan; los <b>créditos ◈</b> son lo que se canjea. Sin tope: a su ritmo, y si alguien registra muchos de golpe, su docente lo ve.'},
