...
(function () {
  ...
  function radioNave() {
    return [
      ...
      rx("retos-doc", "Retos", "Tu Nave → Retos", "Cada reto: qué piden y quién lo ha hecho",
        ['<b>Esta semana</b>, con cuántos lo llevan hecho.', '<b>Ya lanzados</b>, por tema: la cuenta de cada reto.', '<b>Lo que viene</b>, en sombra, con su semana. Pulsa cualquiera: qué tienen que hacer, paso a paso, y <b>quién lo ha hecho, con su enlace</b>.'],
        'Para enseñar un buen trabajo en clase: el reto, su enlace, y a la pantalla.'),
