...
function crearPER(datos) {
  ...
  if (_t.sobra(60000)) { try { var _im = imagenesFormularios_(fb, ft, fc, _t); pend.imagenes = _im.faltan > 0; _t.hito("imagenes de los formularios (" + _im.puestos + " puestas, " + _im.faltan + " pendientes)"); }
