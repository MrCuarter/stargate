...
var AYUDA_RETOS = {
 ...
 "A1": "Comparte en el foro de la plataforma de UNIR algo que tengas a medias —o que dejaste a medias— tal como está: un recurso, una unidad, una idea que se quedó en un cajón. Añade dos frases: en qué punto se quedó y qué te frenó para terminarlo. Pega el enlace de tu publicación o del propio archivo (con permiso de lectura). No se corrige ni se puntúa: el único criterio es sacarlo del cajón y compartirlo sin terminar.",
 ...
 "A6": "Coge algo que tus alumnos temen o les cuesta y conviértelo en un pequeño ensayo jugable, digital o analógico (una mecánica: puntos, rutas, unas cartas, un enigma en cada paso…). Enséñalo: una foto o un documento con 4–6 líneas si es analógico, el enlace si es digital; pega ese enlace. Criterio: que el juego sirva a un objetivo, no que sea juego por juego.",
 "A7": "Toma una tarea rutinaria de tu aula y escribe el «porqué» / la narrativa que la convierte en una causa (2–4 líneas). Y sobre todo, crea la insignia que la reconoce: diséñala (con Genially, Canva, una IA o a mano), ponle nombre y di qué acto significativo reconoce —no un premio por obedecer, sino memoria de algo que importa. Pega el enlace a tu insignia y a su porqué.",
