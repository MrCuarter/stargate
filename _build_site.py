...
AVERIAS = [
 ...
 ("retos", "A un estudiante no le suman los retos o los créditos",
  ...
  "Tres cosas lo explican casi siempre: 1) como mucho <b>3 retos al día</b>; 2) casi todos piden el <b>enlace</b> de lo que se ha hecho "
...
_PE = [
 ...
 ("4 · El aula (la clase en directo)", [
   ...
   ("Pestaña «🗳️ Votación»: escribe una pregunta («¿qué herramienta vemos la semana que viene?»), dos o tres opciones y publícala.",
 ...
 ("7 · Como estudiante (con tu otra cuenta)", [
   ...
   ("Al acabar el viaje (última semana), en la Nave sale «📜 Tu diploma».", "Con tu alias, tu nombre, tus insignias y tus cifras, firmado por tu Comandante. Se descarga o se imprime.")
 ]),
]
def _pe_html():
    n = 0; out = []
...
''' + '<script>window.SG_BADGES=' + json.dumps(NAVE_BADGES) + ';window.SG_BADGE_NAMES=' + json.dumps(BADGE_NAME, ensure_ascii=False) + ';window.SG_BATALLA=' + json.dumps(BATALLA, ensure_ascii=False) + ';</script>' + '<script src="' + _v("assets/js/consola.js") + '" defer></script>' + '<script src="' + _v("assets/js/tablero.js") + '" defer></script>' + '''
</div></section>
''' + FOOT
