...
<li><b>Limpiar formularios huérfanos</b> (menú → Mantenimiento): manda a la papelera los formularios de la carpeta «Formularios PER» que ya no pertenecen a ningún PER de la hoja (te enseña la lista antes). Útil si borraste algún PER con una versión anterior del script, que dejaba suelto el formulario de canje.</li>
