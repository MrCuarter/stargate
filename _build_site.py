...
from _site_data import (GOOGLE_CLIENT_ID,
                        ...
                        HEROES, HEROES_OCULTOS, AYUDA_RETOS, GANCHO_RETOS, EJEMPLOS_RETOS, ESCAPE_UNI, EVIDENCIA_RETOS, REFLEXION_RETOS, TOPE_RETOS_SEMANA, AVISO_RETOS_DIA, SESION_SECCIONES, ACTIVIDADES, EVALUACION, EVALUACION_EXAMEN, SESION_EMBARQUE, ASIGNATURA, BLOQUES_ASIGNATURA, TEMARIO, SESION_ACTIVIDAD, MATRIZ_PLANTILLA, INTELIGENCIAS, BLOOM, ORTOGRAFIA, CAPTURAS, IMG_RECOMPENSA, BONUS_PLANETA, BONUS_RACHA, BONUS_TUTORIAL, _AYUDA_DOC,
