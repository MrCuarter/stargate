...
c(/function selectorModo\(\)/.test(K) && /Piloto automático/.test(K) && /Mando manual/.test(K) && (K.match(/selectorModo\(\)/g) || []).length >= 2 && /'<div class="cn-ficha-b">' \+ selectorModo\(\)/.test(K), "   con su selector en tu ficha de comandante (el Puente)");
