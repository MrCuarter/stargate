...
c(/class="doc-panel"/.test(CONS) && /data-av="c' \+ n \+ '"/.test(CONS), "🔴 consola · panel del docente con su comandante, que se cambia de una galería");
c([1, 2, 3, 4, 5, 6, 7, 8].every(n => fs.existsSync(path.join(RAIZ, "assets/img/avatares/comandantes/c" + n + ".jpg"))), "   los ocho comandantes (Magnific)");
